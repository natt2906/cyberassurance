  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white">
      ...
      <main className="px-4 pt-24 pb-16">
        <ArticleJsonLd slug="combien-coute-une-cyberattaque" />
        <ArticleSeoMeta slug="combien-coute-une-cyberattaque" />
...
<p className="text-blue-200 leading-relaxed mb-4">
  Le thème <strong>Combien coûte réellement une cyberattaque pour une petite entreprise ?</strong> peut sembler abstrait tant que tout va bien.
...
<p className="text-blue-200 leading-relaxed mb-4">
  En pratique, ignorer le sujet “Combien coûte réellement une cyberattaque pour une petite entreprise ?” peut se traduire par plusieurs types
...
<p className="text-blue-200 leading-relaxed mb-4">
  ...
  “Combien coûte réellement une cyberattaque pour une petite entreprise ?”, peuvent déjà faire une vraie différence : mieux protéger les accès,
