...
export default function ArticleCyberRGPD() {
  return (
    <div className="min-h-screen bg-[#020617] text-white">
      <MainNavbar />
      <main className="px-4 pt-24 pb-16">
        <ArticleJsonLd slug="cyber-et-rgpd" />
        <ArticleSeoMeta slug="cyber-et-rgpd" />
...
<p className="text-blue-200 leading-relaxed mb-4">
  Le thème <strong>Cyber-risque et RGPD : ce que doit savoir une petite entreprise</strong> peut sembler abstrait tant que tout va bien.
...
<p className="text-blue-200 leading-relaxed mb-4">
  En pratique, ignorer le sujet “Cyber-risque et RGPD : ce que doit savoir une petite entreprise” peut se traduire par plusieurs types
...
<p className="text-blue-200 leading-relaxed mb-4">
  ...
  “Cyber-risque et RGPD : ce que doit savoir une petite entreprise”, peuvent déjà faire une vraie différence : mieux protéger les accès,
...
<p className="text-blue-200 leading-relaxed mb-8">
  ...
  questions seulement.
      ...
      <RelatedArticles currentSlug="cyber-et-rgpd" />
