...
<p className="text-blue-200 leading-relaxed mb-4">
  Le thème <strong>Cas concret : comment une PME a géré une cyberattaque majeure</strong> peut sembler abstrait tant que tout va bien.
...
<p className="text-blue-200 leading-relaxed mb-4">
  En pratique, ignorer le sujet “Cas concret : comment une PME a géré une cyberattaque majeure” peut se traduire par plusieurs types
...
<p className="text-blue-200 leading-relaxed mb-4">
  ...
  “Cas concret : comment une PME a géré une cyberattaque majeure”, peuvent déjà faire une vraie différence : mieux protéger les accès,
