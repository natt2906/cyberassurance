  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white">
      ...
      <main className="px-4 pt-24 pb-16">
        <ArticleJsonLd slug="fraude-email-usurpation" />
        <ArticleSeoMeta slug="fraude-email-usurpation" />
        ...
        <p className="inline-flex items-center px-3 py-1 mb-6 text-xs font-semibold rounded-full bg-blue-500/10 text-blue-200 border border-blue-500/40">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
            Fraudes par email : obligations de l’assuré et bonnes pratiques
          </h1>
          ...
          <p className="text-sm text-blue-300 mb-8">
            Clarifier les obligations de l’assuré face aux fraudes par email.
          </p>

          <p className="text-lg text-blue-200 leading-relaxed mb-8">
  En assurance cyber, les fraudes par email sont un fait générateur fréquent. L’enjeu est de cadrer les obligations de l’assuré et l’étendue des garanties.
</p>
...
<p className="text-blue-200 leading-relaxed mb-8">
  N’attendez pas un sinistre pour agir. Un courtier spécialisé en assurance cyber peut vous aider à ajuster votre couverture en fonction de votre secteur et de votre chiffre d’affaires.
      ...
      <RelatedArticles currentSlug="fraude-email-usurpation" />
